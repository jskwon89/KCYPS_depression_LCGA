...
plt.rcParams.update({'font.family': 'DejaVu Sans', 'font.size': 11,
                     ...
                     'legend.fontsize': 10, 'savefig.dpi': 300})
...
ax.set_xlim(0.7, 7.6)
plt.tight_layout()
plt.savefig(os.path.join(FIGS, 'Figure1_LCGA_trajectories_9item.png'), dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(os.path.join(FIGS, 'Figure2_suicidal_ideation_9item.png'), dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(os.path.join(FIGS, 'Figure3_baseline_heatmap_9item.png'), dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(os.path.join(FIGS, 'Figure4_distal_forest_9item.png'), dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(os.path.join(FIGS, 'Figure5_fit_indices_9item.png'), dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig(os.path.join(FIGS, 'Figure6_time_varying_HR_9item.png'), dpi=300, bbox_inches='tight')
